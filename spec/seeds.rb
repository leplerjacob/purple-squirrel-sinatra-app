...
# listings_hash = JSON.parse(json_listings)
Listing.destroy_all

listings.each{|listing|
     {position: listing.position, description: listing.description, salary: listing.salary, date_posted: listing.date_posted}.create()      
}
